...
Only return the full `git commit -m "..."` command in your response. Do not include any additional meta-commentary about the task. Do not include the raw diff output in the commit message. Do not run the command.
...
- Lowercase type prefix, capitalize the description
